...
const Profile: FC<Props> = ({ user }) => {
  ...
  return (
    <div className="w-[85%] flex mx-auto ">
      <div
        className={`w-[60px] 800px:w-[310px] h-[400px] dark:bg-slate-900 bg-white bg-opacity-90 border border-[#ffffff14] dark:border-[#ffffff1d] rounded-[5px]  shadow-sm dark:shadow-sm mt-[80px] mb-[80px] sticky ${
