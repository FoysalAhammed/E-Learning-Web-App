...
//           "id": 1564556945,
//           "userName": "user1",
//           "userEmail": "hanif.mia2233@gmail.com",
//           "title": "Product A",
//           "price": 29.99,
...
// },
  ...
  return (
  <div className={isDashboard ? "mt-[20px]" : "mt-[0px]"}>

    {
      isLoading ? (
        ...
        <Box m={isDashboard ? "0" : "40px"}>
          ...
          >
            <DataGrid checkboxSelection={isDashboard ? false:true} rows={rows} columns={columns} components={isDashboard ? {}: {Toolbar:GridToolbar}} />
          </Box>
        </Box>
      )}
    </div>
