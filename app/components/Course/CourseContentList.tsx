...
const CourseContentList: FC<Props> = (props) => {
  ...
  // find unique video sections from courses
  ...
  return (
    ...
    >
      {videoSections.map((section: string, sectionIndex: number) => {
        ...
        const sectionVideCount: number = sectionVideos.length; // number of videos in the current section
